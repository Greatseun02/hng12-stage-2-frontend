    ...
    return (
        <>
            <div className='text-center p-[16px_24px] border-x-2 border-t-0 border-b-2 border-[#07373F] rounded-3xl backdrop-blur-sm bg-[#0A0C11]/10 bg-radial-[#24A0B5/0,#24A0B5/20]'>
                ...
                <p className='text-sm mb-7'>Join us for an unforgettable experience at [Event Name]! Secure your spot now.</p>
                <p>📍 [Event Location]</p>
            ...
            <div>
                ...
                <div className='grid gap-3 bg-[#052228] border-[1px] border-[#07373F] rounded-3xl p-4'>
                    <div onClick={()=>{
                        setTicket("free")
